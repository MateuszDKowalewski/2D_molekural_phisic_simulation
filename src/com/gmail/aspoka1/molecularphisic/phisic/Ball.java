...
public class Ball implements Physic, Drawable {
	...
	public static final int DEFAULT_INIT_AIR_WEIGHT = 116;
	public static final int DEFAULT_INIT_SURFACE_ELASTICITY = 46;
	public static final int DEFAULT_INIT_AIR_PRESSURE = 196;
